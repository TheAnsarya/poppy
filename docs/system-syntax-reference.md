...
| Genesis | Motorola 68000 | `genesis` | `genesis` | M68000 profile supports deterministic integration-verified operand-bearing forms including `moveq #imm,dn`, `jmp $address`, and `jsr (an)` |
