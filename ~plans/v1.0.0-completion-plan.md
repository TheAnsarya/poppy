...
- [ ] Integrate SnesRomBuilder with CodeGenerator

#### Game Boy Completion
- [x] Verify all SM83 instructions emit correctly
- [x] GB ROM builder with header placement
- [x] Checksum/complement bytes
- [ ] Integrate GbRomBuilder with CodeGenerator
