...
|-----------|--------|-------|-------|
| Lexer | ✅ 100% | 125 | All token types supported |
| Parser | ✅ 100% | 67 | Full AST generation |
| 6502 Instructions | ✅ 100% | 100+ | All 56 opcodes |
| 65816 Instructions | ✅ 95% | 50+ | M/X sizing fixed, bank:addr missing |
| SM83 Instructions | ✅ 100% | 40+ | All Game Boy opcodes |
| Semantic Analysis | ✅ 100% | 150+ | Symbols, labels, scoping |
| Code Generation | ✅ 95% | 100+ | SNES ROM layout needed |
| Macro System | ✅ 100% | 60+ | Full macro support |
| Include System | ✅ 100% | 30+ | .include, .incbin |
| iNES Headers | ✅ 100% | 20+ | iNES 1.0/2.0 |
| SNES Headers | ⚠️ 80% | 10+ | Layout placement needed |
| GB Headers | ⚠️ 70% | 5+ | Needs testing |
| Debug Symbols | ✅ 100% | 20+ | .nl, .mlb, .sym |
| Error Reporting | ✅ 100% | 24+ | Context, formatting |

**Total Tests:** 896 passing

### VS Code Extension Progress

| Feature | Status | Notes |
|---------|--------|-------|
| Syntax Highlighting | ✅ 100% | 6502/65816/SM83 |
| IntelliSense | ✅ 100% | Opcodes, directives, labels |
| Code Snippets | ✅ 100% | 40+ snippets |
| Formatting | ✅ 100% | Column alignment |
| Go-to-Definition | ✅ 100% | Labels |
| Hover Info | ✅ 100% | Opcode docs |
| Build Tasks | ✅ 100% | Integrated |
| Diagnostics | ✅ 100% | Real-time |
| Test Suite | ✅ 100% | 13 tests |
...
- [ ] Generate SNES ROMs with proper header placement
- [ ] Generate Game Boy ROMs with proper header placement
...
- [ ] Bank:Address notation parsing ($7e:1234)
- [ ] Proper SNES ROM layout (header at $7fc0/$ffc0)
- [ ] Checksum calculation

#### Game Boy Completion
- [ ] Verify all SM83 instructions emit correctly
- [ ] GB ROM header placement ($0100-$014f)
- [ ] Checksum/complement bytes

#### Testing
- [x] 800+ unit tests passing
- [ ] Integration tests for SNES ROM generation
- [ ] Integration tests for GB ROM generation
- [ ] Manual test with real emulators

#### Documentation
- [x] User manual
- [x] SNES development guide
- [ ] Game Boy development guide
...
|----|------|--------|-----|----------|
| T1 | Bank:Address notation parsing | ⬜ | 3h | P0 |
| T2 | SNES ROM layout builder | ⬜ | 4h | P0 |
| T3 | SNES checksum calculation | ⬜ | 2h | P0 |
| T4 | SNES integration tests | ⬜ | 3h | P0 |
| T5 | SNES example project | ⬜ | 2h | P1 |
...
| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T6 | GB ROM header placement | ⬜ | 2h | P0 |
| T7 | GB checksum calculation | ⬜ | 1h | P0 |
| T8 | GB header directives | ⬜ | 2h | P1 |
| T9 | GB integration tests | ⬜ | 2h | P1 |
| T10 | GB example project | ⬜ | 2h | P1 |
| T11 | GB development guide | ⬜ | 3h | P2 |
...
| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T12 | Complete user manual | ✅ | - | Done |
| T13 | SNES development guide | ✅ | - | Done |
| T14 | GB development guide | ⬜ | 3h | P1 |
| T15 | ca65 migration guide | ⬜ | 2h | P2 |
| T16 | ASAR migration guide | ⬜ | 2h | P2 |
| T17 | API documentation | ⬜ | 2h | P2 |
...
| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T18 | Publish to marketplace | ⬜ | 1h | P0 |
| T19 | Create extension icon | ⬜ | 1h | P1 |
| T20 | Update README | ⬜ | 1h | P1 |
...
| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T21 | Define poppy.json format | ⬜ | 2h | P2 |
| T22 | Project file parser | ⬜ | 3h | P2 |
| T23 | Multi-file compilation | ⬜ | 3h | P2 |
| T24 | Watch mode | ⬜ | 2h | P3 |

### Epic 6: Examples & Testing (Priority: P1)

| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T25 | SNES hello-world example | ⬜ | 2h | P1 |
| T26 | GB hello-world example | ⬜ | 2h | P1 |
| T27 | Test with bsnes emulator | ⬜ | 1h | P1 |
| T28 | Test with bgb emulator | ⬜ | 1h | P1 |

### Epic 7: Release Preparation (Priority: P0)

| ID | Task | Status | Est | Priority |
|----|------|--------|-----|----------|
| T29 | Version bump to 1.0.0 | ⬜ | 0.5h | P0 |
| T30 | Update CHANGELOG | ⬜ | 1h | P0 |
| T31 | Create release notes | ⬜ | 1h | P0 |
| T32 | Tag release | ⬜ | 0.5h | P0 |
| T33 | GitHub release | ⬜ | 0.5h | P0 |
| T34 | Announce release | ⬜ | 0.5h | P0 |
