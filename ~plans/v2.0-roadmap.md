...
**Status:** Planned for v2.0.0
**Instruction Set:** 6507 (6502 variant with reduced addressing)
**Priority:** Medium
...
**Status:** Planned for v2.0.0
**Instruction Set:** HuC6280 (65C02 + custom features)
**Priority:** Medium

### WonderSwan / WonderSwan Color (NEC V30MZ)

**Status:** Planned for v2.1.0
**Instruction Set:** V30MZ (80186 compatible)
**Priority:** Low

### Atari Lynx (65C02)

**Status:** Planned for v2.1.0
**Instruction Set:** 65SC02
**Priority:** Low

### Neo Geo Pocket / Neo Geo Pocket Color (TLCS-900H)

**Status:** Planned for v2.2.0
**Instruction Set:** TLCS-900H (Toshiba)
**Priority:** Low
