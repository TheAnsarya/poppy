...
public sealed class SemanticAnalyzer : IAstVisitor<object?> {
	...
	/// <summary>Gets or sets the iNES PRG ROM size (in 16KB units).</summary>
	public int? InesPrgSize { get; private set; }
	/// <summary>Gets or sets the iNES CHR ROM size (in 8KB units).</summary>
	public int? InesChrSize { get; private set; }
	/// <summary>Gets or sets the iNES mapper number.</summary>
	public int? InesMapper { get; private set; }
	/// <summary>Gets or sets the iNES 2.0 submapper number.</summary>
	public int? InesSubmapper { get; private set; }
	/// <summary>Gets or sets the iNES mirroring mode (true = vertical, false = horizontal).</summary>
	public bool? InesMirroring { get; private set; }
	/// <summary>Gets or sets whether the cartridge has battery-backed save RAM.</summary>
	public bool InesBattery { get; private set; }
	/// <summary>Gets or sets whether the ROM has a 512-byte trainer.</summary>
	public bool InesTrainer { get; private set; }
	/// <summary>Gets or sets whether to use four-screen VRAM mode.</summary>
	public bool InesFourScreen { get; private set; }
	/// <summary>Gets or sets the iNES PRG RAM size.</summary>
	public int? InesPrgRamSize { get; private set; }
	/// <summary>Gets or sets the iNES CHR RAM size.</summary>
	public int? InesChrRamSize { get; private set; }
	/// <summary>Gets or sets whether the ROM targets PAL (true) or NTSC (false).</summary>
	public bool InesPal { get; private set; }
	/// <summary>Gets or sets whether to use iNES 2.0 format (default: true).</summary>
	public bool UseINes2 { get; private set; } = true;
	...
	private void HandleINesDirective(DirectiveNode node) {
		...
		switch (directiveName) {
			...
			case "ines_mirroring":
				...
				InesMirroring = value != 0;    // 0 = horizontal, 1 = vertical
				break;

			case "ines_battery":
				InesBattery = value is null || value != 0;
				break;

			case "ines_trainer":
				InesTrainer = value is null || value != 0;
				break;

			case "ines_fourscreen":
				InesFourScreen = value is null || value != 0;
				break;
			...
			case "ines_chrram":
				...
				InesChrRamSize = (int)value;
				break;

			case "ines_pal":
				InesPal = value is null || value != 0;
				break;

			case "ines2":
				UseINes2 = value is null || value != 0;
				break;
		}
